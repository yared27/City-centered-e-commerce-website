...
if(!isset($login_session)){
  ...
  if (move_uploaded_file($_FILES['images_path']['tmp_name'], $target_file)) {
      echo "The file ". basename($images_path). " has been uploaded.";
  } else {
  ...
  $sql = "INSERT INTO item (name, price, description, images_path, R_ID, category_id, subcategory_id) VALUES ('$name', '$price', '$description', '$target_file', '$R_ID', '$category_id', '$subcategory_id')";
...
>
  ...
  <div class="container">
    <div class="jumbotron">
      ...
      <center>
         <label style="margin-left: 5px;color: red;"> <h1>Please add items.</h1> </label>
