  ...
  <div class="row">
    <div class="col-xs-3" style="text-align: center;">
      <div class="list-group"><br><br><br><br><br><br><br><br>
        ...
        <a href="Delete_items.php" class="list-group-item active">Delete Item</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="delete_items1.php" method="POST">
          <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px; background-color:rgba(255, 255, 255, 0.5); color: #343a40; ">Item Delete/Disable</h3>

          <?php
          // Storing Session
          $user_check = $_SESSION['login_user1'];
          $sql = "SELECT * FROM item f WHERE f.options = 'ENABLE' AND f.R_ID IN (SELECT r.R_ID FROM shops r WHERE r.M_ID='$user_check') ORDER BY F_ID";
          ...
          ?>
            ...
            <div class="form-group">
                            <button type="submit" id="submit" name="submit" class="btn dark-form-button pull-right" onclick="display_alert()" value="Display alert box"> Delete </button>
                        </div
          <?php } else { ?>
