...
<ul class="nav navbar-nav navbar-right">
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="fa fa-pencil"></span> Sign Up <span class="caret"></span> </a>
                <ul class="dropdown-menu">
              <li> <a href="customersignup.php"> User Sign-up</a></li>
              <li> <a href="managersignup.php"> Manager Sign-up</a></li>
...
?>
    ...
    <div class="marginit2">
    <h2>About Us</h2>
    <p>40Gebeya is a family-owned and operated grocery store that has been serving the community for over 50 years. We are committed to providing our customers with the freshest and highest quality produce, meats, and seaitem at competitive prices.</p>
    <p>We also offer a wide variety of grocery items, including prepared items, baked goods, and dairy products. We are proud to be a one-stop shop for all of your grocery needs.</p>
    <br><br>
    <h3>Our Mission</h3>
    <p>Our mission is to provide our customers with a convenient and enjoyable shopping experience. We are committed to offering our customers the freshest and highest quality products at competitive prices.</p>
    <br>
    <h3>Our Values</h3>
    <br>
    <ul>
      <li>Customer service is our top priority.</li>
      <li>We are committed to quality and freshness.</li>
      <li>We are a family-owned and operated business.</li>
      <li>We support our local community.</li>
    </ul>
    <br>
    <footer style="position: relative; bottom:0%;">
    <p><center>Copyright &copy; 2024 40Gebeya</center></p>
  </footer>
    </div>
  </div>
...
<style>
  .marginit{
    color: #eee; font-family: Poppins; font-size: 12px; background-image: url(image/background.jpg); background-repeat: no-repeat; background-size: cover; overflow: scroll; 
  }
  .marginit2{
