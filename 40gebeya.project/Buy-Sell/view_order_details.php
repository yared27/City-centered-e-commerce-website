...
<br><br><br><br><br><br><br><br>
      <div class="list-group">
			...
			<a href="view_order_details.php" class="list-group-item active">Orders Detail</a>
    	</div>
    </div>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px; color:#343a40; background-color:rgba(255,255,255,0.5);"> Orders Received </h3>
...
<tbody>
  <tr>
    ...
    <td><a href="delete_order.php?order_ID=<?php echo $row["order_ID"]; ?>">Delete</a></td>
  </tr>
</tbody>
